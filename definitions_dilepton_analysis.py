...
histogram_settings = {
    'variables' : {
        ...
        'nNu'                       : {'binning' : (0,5,6),      'xlim' : (0,5),    'xlabel' : "$N_{\nu_{reco}}$"},
        'nNubar'                    : {'binning' : (0,5,6),      'xlim' : (0,5),    'xlabel' : "$N_{\bar{\nu}_{reco}}$"},
        'nNuGen'                    : {'binning' : (0,5,6),      'xlim' : (0,5),    'xlabel' : "$N_{\nu_{gen}}$"},
        'nNubarGen'                 : {'binning' : (0,5,6),      'xlim' : (0,5),    'xlabel' : "$N_{\bar{\nu}_{gen}}$"},
        'ratioNuPtGenReco'          : {'binning' : (-5,5,101),   'xlim' : (-5,5),    'xlabel' : r'$p_{T}^{\nu_{gen}} / p_{T}^{\nu_{reco}}$ [GeV]'},
        'ratioNubarPtGenReco'       : {'binning' : (-5,5,101),   'xlim' : (-5,5),    'xlabel' : r'$p_{T}^{\bar{\nu}_{gen}} / p_{T}^{\bar{\nu}_{reco}}$ [GeV]'},
        'deltaRNuNuGen'             : {'binning' : (0,5,65),     'xlim' : (0,5),    'xlabel' : r'${\Delta}R_{\nu_{reco},\nu_{gen}}$'},
        'deltaRNubarNubarGen'       : {'binning' : (0,5,65),     'xlim' : (0,5),    'xlabel' : r'${\Delta}R_{\bar{\nu}_{reco},\bar{\nu}_{gen}}$'},
        'deltaRLeptonPlusHiggs'     : {'binning' : (0,5,65),     'xlim' : (0,5),    'xlabel' : r'${\Delta}R_{H,\ell^+$'},
        'deltaRLeptonMinusHiggs'    : {'binning' : (0,5,65),     'xlim' : (0,5),    'xlabel' : r'${\Delta}R_{H,\ell^-$'},
