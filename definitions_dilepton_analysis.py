...
histogram_settings = {
    'variables' : {
        ...
        'met'                       : {'binning' : (0,2000,201), 'xlim' : (0,500),  'xlabel' : "$p_{T}^{MET}$ [GeV]"},
        'met_cuts'                  : {'binning' : (0,2000,201), 'xlim' : (0,500),  'xlabel' : "$p_{T}^{MET}$ [GeV]"},
        'mll'                       : {'binning' : (0,1500,301), 'xlim' : (0,500),  'xlabel' : "$m_{\ell\ell}$ [GeV]"},
        'mll_cuts'                  : {'binning' : (0,1500,301), 'xlim' : (0,500),  'xlabel' : "$m_{\ell\ell}$ [GeV]"},
        ...
        'ptll'                      : {'binning' : (0,2000,201), 'xlim' : (0,500),  'xlabel' : "$p_{T}^{\ell\ell}$ [GeV]"},
        'ptll_cuts'                 : {'binning' : (0,2000,201), 'xlim' : (0,500),  'xlabel' : "$p_{T}^{\ell\ell}$ [GeV]"},
        'mt_ww'                     : {'binning' : (0,1500,301), 'xlim' : (0,500),  'xlabel' : "$m_{T}^{WW}$ [GeV]"},
        'mt_ww_cuts'                : {'binning' : (0,1500,301), 'xlim' : (0,500),  'xlabel' : "$m_{T}^{WW}$ [GeV]"},
