...
histogram_settings = {
    'muons_pt'                  : {'binning' : (0,2000,201), 'xlim' : (0,500),  'xlabel' : "$p^{T}_{\mu}$ [GeV]"},
    'muons_eta'                 : {'binning' : (-4,4,81),    'xlim' : (-4,4),   'xlabel' : "$\eta_{\mu}$"},
    'goodmuons_pt'              : {'binning' : (0,2000,201), 'xlim' : (0,500),  'xlabel' : "$p^{T}_{\mu}$ [GeV]"},
    'goodmuons_eta'             : {'binning' : (-4,4,81),    'xlim' : (-4,4),   'xlabel' : "$\eta_{\mu}$"},
    'goodmuons_res_pt'          : {'binning' : (0,2000,201), 'xlim' : (0,500),  'xlabel' : "$p^{T}_{\mu}$ [GeV]"},
    'goodmuons_res_eta'         : {'binning' : (-4,4,81),    'xlim' : (-4,4),   'xlabel' : "$\eta_{\mu}$"},
    'goodmuons_boost_pt'        : {'binning' : (0,2000,201), 'xlim' : (0,500),  'xlabel' : "$p^{T}_{\mu}$ [GeV]"},
    'goodmuons_boost_eta'       : {'binning' : (-4,4,81),    'xlim' : (-4,4),   'xlabel' : "$\eta_{\mu}$"},
    'goodmuons_cuts_pt'         : {'binning' : (0,2000,201), 'xlim' : (0,500),  'xlabel' : "$p^{T}_{\mu}$ [GeV]"},
    'goodmuons_cuts_eta'        : {'binning' : (-4,4,81),    'xlim' : (-4,4),   'xlabel' : "$\eta_{\mu}$"},
    'electrons_pt'              : {'binning' : (0,2000,201), 'xlim' : (0,500),  'xlabel' : "$p^{T}_{e}$ [GeV]"},
    'electrons_eta'             : {'binning' : (-4,4,81),    'xlim' : (-4,4),   'xlabel' : "$\eta_{e}$"},
    'goodelectrons_pt'          : {'binning' : (0,2000,201), 'xlim' : (0,500),  'xlabel' : "$p^{T}_{e}$ [GeV]"},
    'goodelectrons_eta'         : {'binning' : (-4,4,81),    'xlim' : (-4,4),   'xlabel' : "$\eta_{e}$"},
    'goodelectrons_res_pt'      : {'binning' : (0,2000,201), 'xlim' : (0,500),  'xlabel' : "$p^{T}_{e}$ [GeV]"},
    'goodelectrons_res_eta'     : {'binning' : (-4,4,81),    'xlim' : (-4,4),   'xlabel' : "$\eta_{e}$"},
    'goodelectrons_boost_pt'    : {'binning' : (0,2000,201), 'xlim' : (0,500),  'xlabel' : "$p^{T}_{e}$ [GeV]"},
    'goodelectrons_boost_eta'   : {'binning' : (-4,4,81),    'xlim' : (-4,4),   'xlabel' : "$\eta_{e}$"},
    'goodelectrons_cuts_pt'     : {'binning' : (0,2000,201), 'xlim' : (0,500),  'xlabel' : "$p^{T}_{e}$ [GeV]"},
    'goodelectrons_cuts_eta'    : {'binning' : (-4,4,81),    'xlim' : (-4,4),   'xlabel' : "$\eta_{e}$"},
    'jets_pt'                   : {'binning' : (0,1500,151), 'xlim' : (0,500),  'xlabel' : "$p^{T}_{j}$ [GeV]"},
    'jets_eta'                  : {'binning' : (-4,4,81),    'xlim' : (-4,4),   'xlabel' : "$\eta_{j}$"},
    'goodjets_pt'               : {'binning' : (0,1500,151), 'xlim' : (0,500),  'xlabel' : "$p^{T}_{j}$ [GeV]"},
    'goodjets_eta'              : {'binning' : (-4,4,81),    'xlim' : (-4,4),   'xlabel' : "$\eta_{j}$"},
    ...
    'btags_resolved'            : {'binning' : (0,20,21),    'xlim' : (0,20),   'xlabel' : "$N_{btags_res}$"},
